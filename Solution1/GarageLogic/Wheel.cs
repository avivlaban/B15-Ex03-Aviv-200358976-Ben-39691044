...
namespace GarageLogic
{
    public class Wheel
    {
        ...
        {
            return string.Format("Manufactor Name: {0}, Current Pressure in Wheel: {1}, Maximal Pressure in Wheel: {2} ", m_ManufacturerName, m_CurrentAirPressure, m_MaxAirPressure);
        }
    }
}
