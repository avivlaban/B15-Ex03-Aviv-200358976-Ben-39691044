...
namespace GarageManagementSystem.ConsoleUI
{
    public class ConsoleUI
    {
        ...
        private const string k_LineSeperator = "******************************************************************************";
        private const string k_EnterChoice = "Please enter the option number you selected: ";
        private const string k_InvalidOption = "Invalid option.";
        private const string k_ReturnToPreviousMenu = "0. Return to previous menu";
        private const string k_ExitProgram = "0. Exit the program";
        private const string k_EnterVehicleRegistrationNumber = "Please enter the vehicle registration number: ";
...
";
        ...
        private const string k_NewVehicleMenuHeader =
@"
          Enter new vehicle to the system
{0}
";

        private const string k_NewVehicleMenuSelectVehicleType =
@"
...
";
        ...
        private const string k_NewVehicleMenuSelectEngineType =
@"
...
";
        ...
        private const string k_NewVehicleMenuEnterDetails =
@"
          Enter details for {1}, {2}, {3} engine
{0}
";
        
        private const string k_NewVehicleMenuEnterDetailsCarColor =
@"
          Enter details for {1}, {2}, {3} engine
{0}
...
";
        ...
        private const string k_NewVehicleMenuEnterDetailsTruck =
@"
          Enter details for {1}, {2}, {3} engine
{0}
...
";
        ...
        private const string k_NewVehicleMenuEnterDetailsMotorcycle =
@"
          Enter details for {1}, {2}, {3} engine
{0}
...
";
        ...
        private const string k_NewVehicleMenuEnterDetailsGasEngineFuelType =
...
";
        ...
        private const string k_ShowListOfRegistrationNumbersMenu =
@"
...
";
        ...
        private const string k_ChangeVehicleStatusMenuHeader =
@"
          Change existing vehicle status
{0}
";
        
        private const string k_ChangeVehicleStatusMenu =
@"
...
";
        ...
        private const string k_FillAirInTheWheelsHeader =
@"
          Fill the air in the wheels to max pressure
{0}
";

        private const string k_FillGasInVehicleHeader =
@"
          Fill the gas in the vehicle
{0}
";
        
        private const string k_FillGasInVehicleFuelTypes =
...
";
        ...
        private const string k_FillGasInVehicleAmountOfFuel =
@"
          Fill the gas in the vehicle {1}
{0}
Enter the amount of {2} to fill: ";

        private const string k_ChargeBatteryInVehicleHeader =
@"
...
";
        ...
        private const string k_ChargeBatteryInVehicleGetMinutes =
@"
          Charge the battery in the vehicle {1}
{0}
Enter the amount of minutes to charge: ";
        
        private const string k_ShowFullDetailsOnTheVehicleHeader =
@"
...
";
        ...
        private void displayMainMenu()
        {
            ...
            System.Console.WriteLine(string.Format(k_MainMenu, k_LineSeperator, k_ExitProgram));
        }
        ...
        private void displayEnterNewVehicleMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_NewVehicleMenuHeader);
        ...
        private void enterVehicleDetails(string i_VehicleRegistration, GarageLogic.eVehicleOptions i_VehicleType, GarageLogic.eEngineType i_EngineType)
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_NewVehicleMenuEnterDetails, k_LineSeperator, i_VehicleRegistration, i_VehicleType, i_EngineType));
        ...
        private void enterTruckDetails(string i_VehicleRegistration, string i_BrandName, string i_OwnerName, string i_OwnerPhoneNumber, string i_WheelsManufacturerName, float i_WheelsCurrentAirPressure)
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_NewVehicleMenuEnterDetailsTruck, k_LineSeperator, i_VehicleRegistration, "Truck", GarageLogic.eEngineType.Gas));
            ...
            getGasEngineDetails(out currentFuelInVehicleInLiters);
            try
            {
                vehicleCreated = m_GarageToManage.CreateTruck(i_BrandName, i_VehicleRegistration, currentFuelInVehicleInLiters, isCurrentLoadDangerous, weightOfCurrentLoad, i_WheelsManufacturerName, i_WheelsCurrentAirPressure);
        ...
        private void enterMotorCycleDetails(string i_VehicleRegistration, string i_BrandName, GarageLogic.eEngineType i_EngineType, string i_OwnerName, string i_OwnerPhoneNumber, string i_WheelsManufacturerName, float i_WheelsCurrentAirPressure)
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_NewVehicleMenuEnterDetailsMotorcycle, k_LineSeperator, i_VehicleRegistration, "Motorcycle", i_EngineType));
            ...
            try
            {
                if (i_EngineType == GarageLogic.eEngineType.Gas)
                {
                    ...
                    getGasEngineDetails(out currentFuelInVehicleInLiters);
                    vehicleCreated = m_GarageToManage.CreateMotorcycle(i_EngineType, motorcycleLicense, i_BrandName, i_VehicleRegistration, currentFuelInVehicleInLiters, engineCC, i_WheelsManufacturerName, i_WheelsCurrentAirPressure);
                }
                else
                {
                    float currentChargeTimeInHours = 0;
                    getElectricEngineDetails(out currentChargeTimeInHours);
                    vehicleCreated = m_GarageToManage.CreateMotorcycle(i_EngineType, motorcycleLicense, i_BrandName, i_VehicleRegistration, currentChargeTimeInHours, engineCC, i_WheelsManufacturerName, i_WheelsCurrentAirPressure);
                }
        ...
        private void enterCarDetails(string i_VehicleRegistration, string i_BrandName, GarageLogic.eEngineType i_EngineType, string i_OwnerName, string i_OwnerPhoneNumber, string i_WheelsManufacturerName, float i_WheelsCurrentAirPressure)
        {
            ...
            GarageLogic.Vehicle vehicleCreated = null;
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_NewVehicleMenuEnterDetailsCarColor, k_LineSeperator, i_VehicleRegistration, "Car", i_EngineType));
            ...
            try
            {
                if (i_EngineType == GarageLogic.eEngineType.Gas)
                {
                    ...
                    getGasEngineDetails(out currentFuelInVehicleInLiters);
                    vehicleCreated = m_GarageToManage.CreateCar(i_EngineType, i_BrandName, i_VehicleRegistration, currentFuelInVehicleInLiters, carColor, numberOfDoors, i_WheelsManufacturerName, i_WheelsCurrentAirPressure);
                }
                else
                {
                    float currentChargeTimeInHours = 0;
                    getElectricEngineDetails(out currentChargeTimeInHours);
                    vehicleCreated = m_GarageToManage.CreateCar(i_EngineType, i_BrandName, i_VehicleRegistration, currentChargeTimeInHours, carColor, numberOfDoors, i_WheelsManufacturerName, i_WheelsCurrentAirPressure);
                }
        ...
        private void getGasEngineDetails(out float o_CurrentFuelInVehicleInLiters)
        {
        ...
        private GarageLogic.eEngineType getEngineTypeFromUser()
        {
            ...
            System.Console.Write(k_NewVehicleMenuSelectEngineType);
        ...
        private GarageLogic.eVehicleOptions getVehicleTypeFromUser()
        {
            ...
            System.Console.Write(k_NewVehicleMenuSelectVehicleType);
        ...
        private void displayShowListOfRegistrationNumbersMenu()
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_ShowListOfRegistrationNumbersMenu, k_LineSeperator, k_ReturnToPreviousMenu, k_EnterChoice));
        ...
        private void displayChangeVehicleStatusMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_ChangeVehicleStatusMenuHeader);
            ...
            {
                System.Console.Clear();
                System.Console.WriteLine(string.Format(k_ChangeVehicleStatusMenu, k_LineSeperator, k_ReturnToPreviousMenu, vehicleRegistrationEntered));
        ...
        private void displayFillAirInWheelsMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_FillAirInTheWheelsHeader);
        ...
        private void displayFillGasVehicleMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_FillGasInVehicleHeader);
        ...
        private int getAmountOfFuelToFillFromUser(string i_VehicleRegistration, GarageLogic.eFuelType i_fuelTypeToFill)
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_FillGasInVehicleAmountOfFuel, k_LineSeperator, i_VehicleRegistration, i_fuelTypeToFill));
        ...
        private GarageLogic.eFuelType getFuelTypeFromUser(string i_VehicleRegistration)
        {
            ...
            Console.Clear();
            Console.WriteLine(string.Format(k_FillGasInVehicleFuelTypes, k_LineSeperator, i_VehicleRegistration));
        ...
        private void displayChargeElectricVehicleMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_ChargeBatteryInVehicleHeader);
        ...
        private float getMinutesToChargeIntoBattery(string i_VehicleRegistration)
        {
            ...
            System.Console.Clear();
            System.Console.WriteLine(string.Format(k_ChargeBatteryInVehicleGetMinutes, k_LineSeperator, i_VehicleRegistration));
            userInput = Console.ReadLine();
        ...
        private void displayShowFullVehicleDetailsMenu()
        {
            ...
            System.Console.Clear();
            vehicleRegistrationEntered = getRegistrationNumberFromUser(k_ShowFullDetailsOnTheVehicleHeader);
            ...
            if (registrationInTheGarage)
            {
                System.Console.WriteLine(string.Format(k_ShowFullDetailsOnTheVehicleHeader, k_LineSeperator, vehicleRegistrationEntered));
        ...
        private int getLegalSelectionFromUser(int i_MinimumNumberChoice, int i_MaximumNumberChoice)
        {
            ...
            System.Console.Write(k_EnterChoice);
            ...
            {
                System.Console.Write(string.Format("{0} {1}", k_InvalidOption, k_EnterChoice));
                userInput = System.Console.ReadLine();
            }
        ...
        {
            string vehicleRegistrationEntered = string.Empty;
            System.Console.WriteLine(string.Format(i_MenuHeader, k_LineSeperator, string.Empty));
            System.Console.Write(k_EnterVehicleRegistrationNumber);
