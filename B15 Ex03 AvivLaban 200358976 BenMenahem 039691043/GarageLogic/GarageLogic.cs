...
namespace GarageLogic
{
    public class GarageLogic
    {
        ...
        public Vehicle CreateMotorcycle(eEngineType i_EngineType, eLicenceType i_LicenceType, string i_BrandName, string i_RegistrationNumber, float i_EnergyLeft, int i_EngineVolume, string i_WheelManufactureName, float i_WheelCurrentPressure)
        {
            CreateVehicleForGarage newVehicle = new CreateVehicleForGarage();
            Vehicle motorcycle = newVehicle.CreateMotorcycle(i_EngineType, i_LicenceType, i_BrandName, i_RegistrationNumber, i_EnergyLeft, i_EngineVolume, i_WheelManufactureName, i_WheelCurrentPressure);
            return motorcycle;
        }

        public Vehicle CreateCar(eEngineType i_EngineType, string i_BrandName, string i_RegistrationNumber, float i_EnergyLeft, eColor i_CarColor, int i_NumberOfDoors, string i_WheelManufactureName, float i_WheelCurrentPressure)
        {
            CreateVehicleForGarage newVehicle = new CreateVehicleForGarage();
            Vehicle car = newVehicle.CreateCar(i_EngineType, i_BrandName, i_RegistrationNumber, i_EnergyLeft, i_CarColor, i_NumberOfDoors, i_WheelManufactureName, i_WheelCurrentPressure);
            return car;
        }

        public Vehicle CreateTruck(string i_BrandName, string i_RegistrationNumber, float i_EnergyLeft, bool i_IsCarryingDangerousMeterials, float i_CurrentCarryingWeight, string i_WheelManufactureName, float i_WheelCurrentPressure)
        {
            CreateVehicleForGarage newVehicle = new CreateVehicleForGarage();
            Vehicle truck = newVehicle.CreateTruck(i_BrandName, i_RegistrationNumber, i_EnergyLeft, i_IsCarryingDangerousMeterials, i_CurrentCarryingWeight, i_WheelManufactureName, i_WheelCurrentPressure);
            return truck;
        }
